...
- **Repositorio y commit/PR evaluado:** La evidencia de mi contribución técnica exacta se encuentra en los commits del Pull Request asociado a la rama `docs/decision-record-carlos` en el repositorio https://github.com/CharlyLP04/pwa-equipo9.
