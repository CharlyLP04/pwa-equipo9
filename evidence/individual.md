...
- **Repositorio y commit evaluado:** La evidencia de mi contribución técnica exacta se encuentra en el Pull Request #1 fusionado en `main`: https://github.com/CharlyLP04/pwa-equipo9/pull/1
...
* **Repositorio y commit evaluado:** Repositorio del equipo `CharlyLP04/pwa-equipo9`. Mi contribución corresponde al Pull Request #3 fusionado en `main`: https://github.com/CharlyLP04/pwa-equipo9/pull/3
...
- **Repositorio y evidencia:** La contribución se encuentra en el Pull Request #2 fusionado en `main`: https://github.com/CharlyLP04/pwa-equipo9/pull/2
